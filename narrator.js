  ...
  class Narrator {
    constructor() {
      ...
      this.chapterLabels = {
        ...
        'mental-model': 'Chapter 02 · Mental Model',
        'under-hood': 'Chapter 03 · Under the Hood',
        'use-cases': 'Chapter 04 · Use Cases',
        'best-practices': 'Chapter 05 · Best Practices',
        'workflows': 'Chapter 06 · Workflows',
        'advanced': 'Chapter 07 · Advanced',
        'whats-new': "Chapter 08 · What's New",
        'qa': 'Chapter 09 · Q & A',
      ...
      this.chapterInfo = {
        ...
        'mental-model':   { num: '02', en: 'Mental Model',     jp: 'Claude Code とは' },
        'under-hood':     { num: '03', en: 'Under the Hood',   jp: '仕組みを覗く' },
        'use-cases':      { num: '04', en: 'Use Cases',        jp: '活用シーン' },
        'best-practices': { num: '05', en: 'Best Practices',   jp: 'ベストプラクティス' },
        'workflows':      { num: '06', en: 'Workflows',        jp: '効率的なワークフロー' },
        'advanced':       { num: '07', en: 'Advanced',         jp: '応用テクニック' },
        'whats-new':      { num: '08', en: "What's New",       jp: '最新アップデート' },
    ...
    async playOpeningCinema() {
      ...
      overlay.innerHTML = `
        <div class="oc-inner">
          ...
          <div class="oc-title-jp">Claude Code</div>
          <div class="oc-title-accent">ベストプラクティス</div>
          <div class="oc-sub">完 全 ガ イ ド</div>
          <div class="oc-line"></div>
          <div class="oc-credit">Based on a talk by <strong>Cal Rueb</strong> · Anthropic</div>
          <div class="oc-event">Code w/ Claude · San Francisco · May 2025</div>
        </div>
      ...
      overlay.innerHTML = `
        <div class="ec-reel">
          ...
          <div class="ec-block">
            ...
            <div class="ec-value">Claude Code ベストプラクティス</div>
            <div class="ec-value is-small">完全ガイド — 音声ナレーション版</div>
          </div>
          ...
          <div class="ec-block">
            ...
            <div class="ec-value">Cal Rueb</div>
            <div class="ec-value is-small">Member of Technical Staff, Anthropic</div>
          </div>

          <div class="ec-block">
            <div class="ec-label">Event</div>
            <div class="ec-value">Code w/ Claude</div>
            <div class="ec-value is-small">San Francisco · May 22, 2025</div>
          </div>
